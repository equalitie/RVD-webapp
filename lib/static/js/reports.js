    ...
    return {
        ...
        draw_table: function(events){
          ...
          for (var i=0; i < events.length; i++){
            ...
            $("#events_table").append(
               '<tr class="event_row"><td>'+events[i].report_date+'</td><td>'+events[i].location+'</td><td>'+event_types_str+'</td><td>'+events[i].description+'</td><td>'+victims_str+'</td><td>'+sources_str+'</td><td>'+events[i].title+'</td><td><a href="/events/'+events[i].id+'">View</td></tr>'
          );
          }
        },
